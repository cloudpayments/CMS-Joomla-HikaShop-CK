...
$MESS["SALE_HPS_CLOUDPAYMENT_calculationPlace_DESC"]="Адрес (адреса) сайта точки продаж для печати в чеке";
...
$MESS["VBCH_CLPAY_SPCP_DDESCR"] = "<a href=\"http://www.http://cloudpayments.ru/\">CloudPayments kassir</a><br/><br/>";
...
$MESS["STATUS_SUCCESS"]="Статус отправки чека";
$MESS["STATUS_REFUND"]="Статус отправки чека возврата";
